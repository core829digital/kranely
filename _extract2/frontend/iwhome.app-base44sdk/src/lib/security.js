/**
 * security.js — Frontend security utilities for IWHome
 *
...
export function injectCSPMeta() {
  ...
  meta.setAttribute('content', [
    "default-src 'self'",
    "script-src  'self' 'unsafe-inline' 'unsafe-eval' https://clerk.iwhome.app https://*.clerk.accounts.dev https://challenges.cloudflare.com",
