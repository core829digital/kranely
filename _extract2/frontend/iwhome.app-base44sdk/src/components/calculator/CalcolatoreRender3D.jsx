  ...
  if (submitted) {
    return (
      <motion.div
        ...
        className="bg-gradient-to-br from-[#495057] to-[#6c757d] border border-blue-400/30 rounded-3xl p-10 text-center max-w-lg mx-auto shadow-2xl"
      >
        <div className="w-16 h-16 rounded-full bg-blue-500/20 border border-blue-400/30 flex items-center justify-center mx-auto mb-5">
        ...
        <div className="bg-[#343a40]/60 rounded-xl p-4 text-left mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            {selectedRooms.map(r => (
              <span key={r.id} className="px-2.5 py-1 bg-blue-500/20 border border-blue-400/20 rounded-full text-blue-200 text-xs">
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl mx-auto">
      ...
      <div className="text-center pb-2">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-400/20 rounded-full mb-4">
      ...
      <div className="bg-gradient-to-br from-[#495057] to-[#6c757d] border border-[#f8f9fa]/15 rounded-2xl p-6 shadow-xl">
        <div className="flex items-center justify-between mb-5">
          ...
          {selectedRooms.length > 0 && (
            <span className="px-3 py-1 bg-blue-500/20 border border-blue-400/20 rounded-full text-blue-200 text-xs">
                    ...
                    >
                      <div className="px-3 pb-3 flex items-center gap-2">
                        <Input
                          ...
                          className="h-8 text-xs rounded-lg bg-[#212529]/60 border-blue-400/30 text-[#f8f9fa] placeholder:text-[#6c757d] focus:border-blue-400/60"
                        />
                        <span className="text-blue-300 text-xs flex-shrink-0">MQ</span>
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
      ...
      <AnimatePresence>
        {selectedRooms.length > 0 && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="bg-[#212529]/80 border border-blue-400/20 rounded-2xl p-5"
          >
      ...
      {/* Info box + Submit */}
      <div className="bg-gradient-to-r from-[#212529] to-[#343a40] border border-blue-400/20 rounded-2xl p-6 shadow-2xl">
        ...
        <Button
          ...
          className="w-full py-5 bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-400 hover:to-blue-500 hover:shadow-2xl rounded-full text-base font-medium transition-all disabled:opacity-50"
        >
          {isSubmitting ? (
