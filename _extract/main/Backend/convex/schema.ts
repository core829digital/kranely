...
export default defineSchema({
    // Users (synced with Clerk via webhooks usually, but simplified here)
    users: defineTable({
        email: v.string(),
        fullName: v.optional(v.string()),
        role: v.optional(v.string()), // admin, client
        tokenIdentifier: v.string(),
        is_company: v.optional(v.boolean()),
        company_role: v.optional(v.string()),
        profile_image: v.optional(v.string()), // NEW: Profile image URL
        work_sector: v.optional(v.string()), // NEW: Work sector
    ...
    }).index("by_token", ["tokenIdentifier"]).index("by_email", ["email"]).index("by_role", ["role"]),
    ...
    quotes: defineTable({
        ...
        client_selected_version_doc_id: v.optional(v.id("documents")), // versione IWHome scelta dal cliente
    ...
    suppliers: defineTable({
        ...
        supplier_code: v.optional(v.string()), // format: IWH-XXXXX
        created_by: v.string(),
        created_date: v.string(),
    ...
    supplier_requests: defineTable({
        ...
        iwhome_margin_price: v.optional(v.number()), // Final price with margin
        iwhome_final_doc_id: v.optional(v.id("documents")), // Final doc for client
    ...
    supplier_deliveries: defineTable({
        ...
        delivery_date: v.optional(v.string()),
        delivery_confirmed_by: v.optional(v.string()), // IWHome confirms receipt
        ...
        client_delivery_date: v.optional(v.string()), // IWHome sets this with the client
    ...
    payments: defineTable({
        ...
        notes: v.optional(v.string()),
        sent_at: v.optional(v.string()), // When IWHome marked as paid
