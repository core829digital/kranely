...
export default function ReferralWidget() {
  ...
  const handleApply = async () => {
    ...
    try {
      ...
      setStatus('success');
      setMessage(`Codice applicato! Hai uno sconto del ${result.discount_percent}% su tutti i servizi Kranely.`);
      setCode('');
    } catch (err) {
      setStatus('error');
          ...
          >
            ...
            <div className="p-5">
              {!isSignedIn ? (
                ...
                <div className="space-y-3">
                  <div className="bg-green-50 border border-green-200 rounded-xl p-4 text-center">
                    ...
                    <p className="text-xs text-green-600 mt-1">
                      Stai beneficiando di uno sconto del <strong>{discount}%</strong> su tutti i servizi Kranely.
                    </p>
                ...
                <div className="space-y-3">
                  <p className="text-xs text-[#6c757d]">Hai un codice referral? Inseriscilo qui per ottenere uno sconto sui servizi Kranely.</p>
