...
export default function ProjectCalculator({ onQuoteChange, windowsPrice = 0 }) {
  ...
  const generateAISuggestions = async () => {
    ...
    const prompt = `Sei un esperto di ristrutturazioni chiavi in mano per Kranely. Analizza questa configurazione e fornisci suggerimenti professionali in italiano:
