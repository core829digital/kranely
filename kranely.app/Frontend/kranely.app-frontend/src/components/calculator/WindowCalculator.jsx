...
export default function WindowCalculator({ onQuoteChange }) {
  ...
  const generateAISuggestions = async () => {
    ...
    const prompt = `Sei un esperto di infissi in PVC per Kranely. Analizza questa configurazione e fornisci suggerimenti professionali in italiano:
    ...
    <div className="bg-gradient-to-br from-[#495057] to-[#6c757d] backdrop-blur-sm border border-[#f8f9fa]/20 rounded-3xl shadow-2xl overflow-hidden">
      ...
      <div className="p-6 lg:p-8 space-y-8">
        ...
        <div className="flex justify-center">
          <Button
            onClick={addWindow}
            className="px-6 py-3 rounded-full bg-gradient-to-r from-[#FFC703] to-[#FFC703] text-white hover:shadow-xl"
          >
