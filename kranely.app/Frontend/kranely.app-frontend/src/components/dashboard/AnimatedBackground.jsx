  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      <motion.div 
        ...
        className="absolute top-0 left-0 bg-gradient-to-br from-[#FFC703]/8 via-[#FFC703]/4 to-transparent rounded-full blur-3xl"
      />
      ...
      <motion.div
        ...
        className="absolute bottom-0 right-0 bg-gradient-to-tl from-[#535252]/12 via-[#535252]/6 to-transparent rounded-full blur-3xl"
      />
    </div>
  );
}
