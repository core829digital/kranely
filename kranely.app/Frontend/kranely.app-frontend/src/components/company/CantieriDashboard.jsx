  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 lg:gap-4">
        <Card className="bg-gradient-to-br from-[#FFC703]/20 to-[#FFC703]/20 border-[#FFC703]/20">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-xs text-[#FFC703] mb-1">Cantieri Attivi</div>
                <div className="text-2xl font-light text-[#f8f9fa]">{cantieriAttivi.length}</div>
              </div>
              <Building className="text-[#FFC703]" size={32} />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-[#FFC703]/20 to-[#FFC703]/20 border-purple-500/30">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-start justify-between">
                  ...
                  <Badge className={
                    cantiere.status === 'attivo'
                      ? 'bg-[#FFC703]/20 border-[#FFC703]/20 text-[#FFC703]'
