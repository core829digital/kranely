...
export default function PdfEditor() {
  ...
  const predefinedTemplates = {
    finestre: {
      ...
      elements: [
        ...
        { id: 8, type: 'text', content: 'ValiditÃ : {{data_validita}}', x: 20, y: 255, style: { fontSize: 10 } },
    ...
    chiavi_in_mano: {
      ...
      elements: [
        ...
        { id: 6, type: 'text', content: 'ModalitÃ  di pagamento: {{termini_pagamento}}', x: 20, y: 245, style: { fontSize: 10 } },
  ...
  const sendForSignature = async () => {
    ...
    await base44.integrations.Core.SendEmail({
      ...
      body: `Gentile ${sendData.cliente_nome},\n\nLe inviamo il preventivo ${numeroPreventivo} per un importo totale di â‚¬ ${totale.toFixed(2)}.\n\nIl preventivo Ã¨ valido fino al ${dataScadenza.toLocaleDateString('it-IT')}.\n\nPuÃ² visualizzare e firmare il documento accedendo alla piattaforma Kranely.\n\nCordiali saluti,\nKranely Team`
    });
  ...
  const generatePDF = () => {
    ...
    templateData.elements.forEach(element => {
      if (element.type === 'text') {
        ...
        doc.text('Q.tÃ ', element.x + 80, startY);
        ...
        doc.text('â‚¬ 0.00', element.x + 120, startY + 10);
        doc.text('â‚¬ 0.00', element.x + 160, startY + 10);
      }
    });
    ...
    doc.setFontSize(14);
    doc.setFont(undefined, 'bold');
    doc.text('TOTALE: â‚¬ _______', 20, 270);
    doc.setFont(undefined, 'normal');

    // Footer
    doc.setFontSize(8);
    doc.text('Kranely - Via Emilia 22/F, Reggio Emilia - 42124', 105, 285, { align: 'center' });
    doc.text('Tel: +39 389 182 0808 | info@kranely.app | admin@kranely.app | P.IVA 03096130350', 105, 290, { align: 'center' });
  ...
  return (
    <div className="min-h-screen bg-[#1C1A18] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-4 sm:py-6 lg:py-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6 lg:mb-8">
            <div>
              ...
              <p className="text-xs sm:text-sm text-white/70">Crea, gestisci e invia preventivi con firma elettronica</p>
            </div>
            <div className="flex flex-wrap gap-2">
              <Button
                ...
                className="bg-gradient-to-r from-[#FFC703] to-[#FFC703] text-white"
              >
            ...
            <div className="flex gap-2 mb-6 border-b border-white/">
              <button
                ...
                className={`px-4 py-2 text-sm font-medium transition-all ${activeTab === 'editor'
                  ? 'text-white border-b-2 border-[#FFC703]'
          ...
          {!isCreating ? (
            <>
              ...
              <div className="mb-6">
                <h2 className="text-lg font-medium text-white mb-4">Template Predefiniti</h2>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <Card
                    className="bg-[#1C1A18]/ backdrop-blur-xl border-white/ hover:bg-[#1C1A18]/ transition-all cursor-pointer"
                    onClick={() => loadPredefinedTemplate('finestre')}
                  >
                    <CardContent className="p-4 text-center">
                      <FileText size={32} className="text-[#FFC703] mx-auto mb-2" />
                      <h3 className="text-sm font-medium text-white">Finestre</h3>
                    </CardContent>
                  </Card>
                  <Card
                    className="bg-[#1C1A18]/ backdrop-blur-xl border-white/ hover:bg-[#1C1A18]/ transition-all cursor-pointer"
                  ...
                  >
                    <CardContent className="p-4 text-center">
                      ...
                      <h3 className="text-sm font-medium text-white">Chiavi in Mano</h3>
                    </CardContent>
                  </Card>
                  <Card
                    className="bg-[#1C1A18]/ backdrop-blur-xl border-white/ hover:bg-[#1C1A18]/ transition-all cursor-pointer"
                  ...
                  >
                    <CardContent className="p-4 text-center">
                      ...
                      <h3 className="text-sm font-medium text-white">Ristrutturazione</h3>
                    </CardContent>
                  </Card>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
                  {templates.map((template) => (
                    <motion.div
                      ...
                      whileHover={{ y: -4 }}
                    >
                      <Card className="bg-[#1C1A18]/ backdrop-blur-xl border-white/ hover:bg-[#1C1A18]/ transition-all">
                        <CardHeader className="pb-3">
                          <div className="flex items-start justify-between">
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 rounded-lg bg-[#FFC703]/20 flex items-center justify-center">
                        ...
                        <CardContent>
                          <div className="flex gap-2">
                            <Button
                              ...
                              className="flex-1 border-white/ text-white hover:bg-white/"
                            >
                  ...
                  {templates.length === 0 && (
                    <div className="col-span-full text-center py-12">
                      <FileText size={64} className="text-white/25 mx-auto mb-4" />
                      <p className="text-white/70 text-lg mb-2">Nessun template trovato</p>
                      <p className="text-white/40 text-sm">Crea il tuo primo template per iniziare</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            /* Catalog Section */
            <Card className="bg-[#1C1A18]/ backdrop-blur-xl border-white/">
              ...
              <Card className="bg-[#1C1A18]/ backdrop-blur-xl border-white/">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-white">Prodotti nel Preventivo</CardTitle>
                    <Button
                ...
                <CardContent>
                  {quoteItems.length > 0 ? (
                    <div className="space-y-3">
                      {quoteItems.map((item) => (
                        <div key={item.id} className="bg-[#535252]/ rounded-lg p-3 border border-white/">
                          <div className="grid grid-cols-12 gap-2 items-center">
                            ...
                            <div className="col-span-2">
                              <Input
                                ...
                                className="bg-[#1C1A18]/ border-white/ text-white text-sm h-8"
                              />
                            </div>
                            <div className="col-span-2">
                              <p className="text-sm text-white/70">â‚¬ {item.prezzo_unitario.toFixed(2)}</p>
                            </div>
                            <div className="col-span-2">
                              <p className="text-sm text-green-400 font-medium">
                                â‚¬ {(item.quantita * item.prezzo_unitario).toFixed(2)}
                              </p>
                            </div>
                      ...
                      <div className="border-t border-white/ pt-3 mt-4">
                        <div className="space-y-2 text-right">
                          <div className="flex justify-between text-sm">
                            <span className="text-white/70">Imponibile:</span>
                            <span className="text-white">â‚¬ {calculateTotals().subtotale.toFixed(2)}</span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span className="text-white/70">IVA (22%):</span>
                            <span className="text-white">â‚¬ {calculateTotals().iva.toFixed(2)}</span>
                          </div>
                          <div className="flex justify-between text-lg font-bold">
                            <span className="text-white">TOTALE:</span>
                            <span className="text-green-400">â‚¬ {calculateTotals().totale.toFixed(2)}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="text-center py-12">
                      <ShoppingCart size={48} className="text-white/25 mx-auto mb-4" />
                      <p className="text-white/70">No products added</p>
                      <p className="text-white/40 text-sm mt-2">Add products from the catalog</p>
                    </div>
                  )}
                </CardContent>
              </Card>
            ...
            <div className="space-y-4">
              <Card className="bg-[#1C1A18]/ backdrop-blur-xl border-white/">
                <CardHeader>
                  <CardTitle className="text-white">Gestione Firme Elettroniche</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 gap-4">
                    {signatures.map((sig) => (
                      <div key={sig.id} className="bg-[#535252]/ rounded-lg p-4 border border-white/">
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-white/70">Cliente: {sig.cliente_nome}</p>
                            <p className="text-xs text-white/40">{sig.cliente_email}</p>
                            <p className="text-xs text-white/40 mt-1">
                        ...
                        {sig.signature_data && (
                          <div className="mt-3 pt-3 border-t border-white/">
                            <p className="text-xs text-white/40 mb-2">Firma Cliente:</p>
                    ...
                    {signatures.length === 0 && (
                      <div className="text-center py-12">
                        <PenTool size={48} className="text-white/25 mx-auto mb-4" />
                        <p className="text-white/70">Nessuna richiesta di firma</p>
            ...
            <div className="space-y-4">
              ...
              <Card className="bg-[#1C1A18]/ backdrop-blur-xl border-white/">
                <CardHeader>
                  <CardTitle className="text-white">Dati Standard</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <Label className="text-white text-xs">Numero Preventivo</Label>
                      <Input
                        value={previewData.numero_preventivo}
                        onChange={(e) => setPreviewData({ ...previewData, numero_preventivo: e.target.value })}
                        className="bg-[#535252]/ border-white/ text-white text-sm"
                      />
                    </div>
                    <div>
                      <Label className="text-white text-xs">Data Emissione</Label>
                      <Input
                    ...
                    <div>
                      <Label className="text-white text-xs">ValiditÃ  fino al</Label>
                      <Input
                    ...
                    <div>
                      <Label className="text-white text-xs">Nome Cliente</Label>
                      <Input
                    ...
                    <div>
                      <Label className="text-white text-xs">Indirizzo Cliente</Label>
                      <Input
                    ...
                    <div>
                      <Label className="text-white text-xs">Telefono</Label>
                      <Input
                    ...
                    <div>
                      <Label className="text-white text-xs">Email Cliente</Label>
                      <Input
                    ...
                    <div className="md:col-span-2">
                      <Label className="text-white text-xs">Termini di Pagamento</Label>
                      <Input
                    ...
                    <div className="md:col-span-2">
                      <Label className="text-white text-xs">Giorni ValiditÃ </Label>
                      <Input
                        type="number"
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {templateData.fields.map((field) => (
                        <div key={field.id}>
                          <Label className="text-white text-xs">{field.label}</Label>
                          {field.type === 'textarea' ? (
                            <Textarea
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
                ...
                <div className="lg:col-span-1 space-y-4">
                  <Card className="bg-[#1C1A18]/ backdrop-blur-xl border-white/">
                    <CardHeader>
                      <CardTitle className="text-white text-base">Impostazioni</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div>
                        <Label className="text-white text-sm">Nome Template</Label>
                        <Input
                      ...
                      <div>
                        <Label className="text-white mb-2 block text-sm">Add Elements</Label>
                        <div className="grid grid-cols-3 gap-2">
                          <Button
                            size="sm"
                            onClick={() => addElement('text')}
                            className="bg-[#535252]/ hover:bg-[#535252] border border-white/"
                            title="Add Text"
                          >
                            <Type size={16} />
                          </Button>
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          <Label className="text-white text-sm">Campi Personalizzati</Label>
                          <Button
                            size="sm"
                            onClick={addField}
                        ...
                        <div className="space-y-2 max-h-[200px] overflow-y-auto">
                          {templateData.fields.map((field) => (
                            <div key={field.id} className="bg-[#535252]/ rounded p-2 border border-white/">
                              <div className="grid grid-cols-2 gap-2 mb-2">
                                <Input
                                  placeholder="Nome (es: durata_lavori)"
                                  value={field.name}
                                  onChange={(e) => updateField(field.id, { name: e.target.value })}
                                  className="bg-[#1C1A18]/ border-white/ text-white text-xs h-7"
                                />
                                <Input
                              ...
                              <div className="grid grid-cols-2 gap-2">
                                ...
                                >
                                  <SelectTrigger className="bg-[#1C1A18]/ border-white/ text-white text-xs h-7">
                                    <SelectValue />
                                  </SelectTrigger>
                                  <SelectContent>
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          {companySignature ? 'Edit Signature' : 'Add Signature'}
                        </Button>
                  ...
                  <Card className="bg-[#1C1A18]/ backdrop-blur-xl border-white/">
                    <CardHeader>
                      <CardTitle className="text-white text-base">Elementi ({templateData.elements.length})</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-2 max-h-[400px] overflow-y-auto">
                      {templateData.elements.map((element) => (
                        <div
                          key={element.id}
                          className="p-2 bg-[#535252]/ rounded-lg border border-white/"
                        >
                          ...
                          {element.type === 'text' && (
                            <div>
                              <Input
                                ...
                                className="bg-[#1C1A18]/ border-white/ text-white text-xs mb-1"
                              ...
                              <div className="flex gap-1">
                                <Input
                                  ...
                                  className="bg-[#1C1A18]/ border-white/ text-white text-xs h-6 w-16"
                                  placeholder="Size"
                                />
                                <Select
                                ...
                                >
                                  <SelectTrigger className="bg-[#1C1A18]/ border-white/ text-white text-xs h-6">
                                    <SelectValue />
                                  </SelectTrigger>
                                  <SelectContent>
                      ...
                      {templateData.elements.length === 0 && (
                        <p className="text-xs text-white/40 text-center py-4">Nessun elemento aggiunto</p>
                      )}
                    </CardContent>
                  </Card>
                  ...
                  {templateData.fields.length > 0 && (
                    <Card className="bg-[#1C1A18]/ backdrop-blur-xl border-white/">
                      <CardHeader>
                        <CardTitle className="text-white text-sm">Campi Disponibili</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-1">
                        {templateData.fields.map((field) => (
                          <div key={field.id} className="flex items-center justify-between text-xs">
                            <span className="text-white/70">{field.label}:</span>
                            <code className="text-white/40 bg-[#535252]/ px-2 py-1 rounded">
                              {'{{' + field.name + '}}'}
                            </code>
                          </div>
                        ))}
                ...
                <div className="lg:col-span-2">
                  <Card className="bg-white border-white/ min-h-[600px]">
                    <CardHeader className="border-b">
                      <CardTitle className="text-[#141210]">Preview con Dati Dinamici</CardTitle>
                    </CardHeader>
                    <CardContent className="p-4 sm:p-8">
                      <div className="bg-white shadow-xl rounded-lg p-4 sm:p-8 min-h-[500px]">
                        {/* Header */}
                        <div className="text-center mb-6">
                          <h2 className="text-2xl font-bold text-[#141210]">PREVENTIVO</h2>
                                  ...
                                  <table className="w-full text-sm">
                                    <thead className="bg-gray-50">
                                      <tr className="border-b">
                                        ...
                                        <th className="text-center py-2 px-3">Q.tÃ </th>
                                    ...
                                    <tbody>
                                      <tr className="border-b">
                                        ...
                                        <td className="text-right py-2 px-3">â‚¬ 450.00</td>
                                        <td className="text-right py-2 px-3">â‚¬ 900.00</td>
                                      </tr>
                                      <tr className="border-b">
                                        <td className="py-2 px-3">Installazione</td>
                                        <td className="text-center py-2 px-3">1</td>
                                        <td className="text-right py-2 px-3">â‚¬ 200.00</td>
                                        <td className="text-right py-2 px-3">â‚¬ 200.00</td>
                                      </tr>
                                    </tbody>
                                  </table>
                        ...
                        <div className="mt-8 pt-4 border-t">
                          <div className="text-right">
                            <div className="text-sm text-gray-600 mb-1">Subtotale: â‚¬ 1.100.00</div>
                            <div className="text-sm text-gray-600 mb-1">IVA 22%: â‚¬ 242.00</div>
                            <div className="text-lg font-bold text-[#141210]">TOTALE: â‚¬ 1.342.00</div>
                          </div>
                        </div>

                        <div className="mt-8 text-center text-xs text-white/25 border-t pt-4">
                          Kranely - Via Montefiorino 10/E, Reggio Emilia<br />
                          Tel: +39 340 292 1052 | info@kranely.app
                        </div>
                      </div>
                    </CardContent>
                  </Card>
      ...
      <Dialog open={showSignatureModal} onOpenChange={setShowSignatureModal}>
        <DialogContent className="bg-gradient-to-br from-[#535252] to-[#535252] border-white/ text-white max-w-2xl" style={{ maxWidth: 'min(calc(100vw - 3rem), 30rem)' }}>
          <DialogHeader>
            <DialogTitle className="text-white">Firma Digitale Azienda</DialogTitle>
          </DialogHeader>
          <div className="mt-4">
      ...
      <Dialog open={showCatalogModal} onOpenChange={setShowCatalogModal}>
        <DialogContent className="bg-gradient-to-br from-[#535252] to-[#535252] border-white/ text-white max-w-4xl" style={{ maxWidth: 'min(calc(100vw - 3rem), 44rem)' }}>
          <DialogHeader>
      ...
      <Dialog open={showSendModal} onOpenChange={setShowSendModal}>
        <DialogContent className="bg-gradient-to-br from-[#535252] to-[#535252] border-white/ text-white">
          <DialogHeader>
            <DialogTitle className="text-white">Invia per Firma al Cliente</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 mt-4">
            <div>
              <Label className="text-white">Nome Cliente</Label>
              <Input
                value={sendData.cliente_nome}
                onChange={(e) => setSendData({ ...sendData, cliente_nome: e.target.value })}
                className="bg-[#1C1A18]/ border-white/ text-white"
                placeholder="Mario Rossi"
              />
            </div>
            <div>
              <Label className="text-white">Email Cliente</Label>
              <Input
                type="email"
            ...
            {templateData.fields && templateData.fields.length > 0 && (
              <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-3 mb-3">
                <p className="text-xs text-white/70 font-medium mb-2">Campi Personalizzati Inclusi:</p>
                <div className="space-y-1">
                  {templateData.fields.map((field) => (
                    <div key={field.id} className="text-xs text-white/40">
                      â€¢ {field.label}: {customFieldsData[field.name] || 'Non compilato'}
                    </div>
                  ))}
                </div>
              </div>
            )}
            <div className="bg-[#FFC703]/10 border border-[#FFC703]/20 rounded-lg p-3">
              <p className="text-xs text-white/70">
                Il preventivo verrÃ  inviato via email al cliente con un link per visualizzarlo e firmarlo digitalmente.
              </p>
            </div>
            <div className="flex gap-2">
              <Button
